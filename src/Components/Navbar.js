    ...
    return (
        <Flex fontSize="35px" width="100%" margin="auto" bg="#d4f1f9" p="10px" alignItems="center" position="fixed" top="0px" zIndex="1000" id="navbar">
            ...
            <Box display="flex" gap="13px" width="45%" >
                ...
                <a href="https://drive.google.com/file/d/1pVySNx5qrrUSjXhqK_yjpaGe7LsTPGan/view?usp=share_link" target="_blank"> <Button fontSize="16px" fontFamily="Arial, Helvetica Neue, Helvetica, sans-serif" p="20px" colorScheme="none" textColor="black" onMouseOver={(event) => {
