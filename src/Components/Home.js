        ...
        <div  id="home">
            ...
            <Flex id="flex_image" width="70%" margin="auto"  alignItems="center" marginTop="180px" >
                ...
                <Box className="text_but">
                    ...
                    <a className='resume' href="https://drive.google.com/file/d/1C0ccYqjAnpCux-kjXuLTcvWbOMXn3KxG/view?usp=share_link" target="_blank" > <Box position="relative" left="0%" top="40px"><Button p="20px" border="3px solid #F40A34" padding="20px 30px 20px 30px" onMouseOver={(event) => {
